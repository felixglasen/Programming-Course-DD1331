...
class Solcell: 
    ...
    def generera_W(self, dag):
        ...
        W = round(self.area * self.soltal * solighetsfaktor * energifunktion(dag, self.latitud, "solkraftverk"), 2)
        return W
...
class Vindturbin:
    ...
    def generera_W(self, dag):
        ...
        W = round(self.rotordiameter * vindfaktor * self.årstidsfaktor(dag) * energifunktion(dag, self.latitud, "vindkraftverk") * 100, 2)
        return W
...
def energifunktion(dag, latitud, kraftverk): 
